...
public class Document {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "This is a presigned S3 link that should be used to attach the document. The maximum size accepted for this document is 50 MB.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Unique identifier for the document.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uri, document.uri) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uri, id, additionalProperties);
  }
